 ...
 */
public class HeightListActivityTest {
    @Rule
    public ActivityTestRule<HeightListActivity> main = new ActivityTestRule<HeightListActivity>(HeightListActivity.class) {
        @Override
    ...
    public void onClick() throws Exception {
        ...
        int position = (int) (Math.random() * ((68 - 0) + 1)) + 0;
        //get expected value
        int listItem = 142 + position;
        ...
        intended(hasComponent(SenseActivity.class.getName()));
        //check intent contains gender just clicked
        intended((
                hasExtras(
                        hasEntry(equalTo("Height Chosen"), equalTo((String.valueOf(listItem)))))));
    ...
    public void testTitleNAme() throws Exception {
        onView(withId(R.id.title)).check(matches(withText("Please select your Height (cm)")));
    }
